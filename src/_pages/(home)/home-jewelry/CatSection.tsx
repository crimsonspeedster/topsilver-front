                    ...
                    <div className="row g-2 g-md-4">
                            ...
                            <div className="row g-2 g-md-4">
                                <div className="col-6 col-md-12">
                                    <Link href="/shop"
                                        ...
                                        <div className="h-100 w-100"
                                             style={{backgroundImage: `url(${banner1.src})`, backgroundSize: 'cover'}}>
                                        </div>
                                ...
                                <div className="col-6 col-md-12">
                                    <Link href="/shop"
                                          className="d-block position-relative cat_grid_item overflow-hidden shops-img">
                                        <div className="h-100 w-100"
                                             style={{backgroundImage: `url(${banner5.src})`, backgroundSize: 'cover'}}>
                                        </div>
                                        <div className="cat-grid-button text-white bg-dark">
                        ...
                        <div className="col-md-6">
                            <div className="row g-2 g-md-4">
                                ...
                                <div className="col-lg-12">
                                    <Link href="/shop"
                                          className="d-none d-md-block position-relative cat_grid_item overflow-hidden shops-img">
                                        <div className="h-100 w-100" style={{
                        ...
                        <div className="col-md-3 mt-0">
                            <Link href="/shop"
                                  className="d-block position-relative cat_grid_item overflow-hidden h-524">
                                <div className="h-100 w-100"
